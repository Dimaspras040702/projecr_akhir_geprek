...
body {
    background: linear-gradient(to bottom right, rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)),
                url('https://www.shutterstock.com/image-photo/ayam-geprek-indonesian-popular-streed-260nw-1844423227.jpg');
...
.card-header {
    background-color:rgb(241, 134, 52); /* Warna utama */
    color: #fff;
    font-size: 1.5rem;
    font-weight: bold;
...
.btn-primary {
    background-color:rgb(241, 134, 52);
    border: none;
    padding: 10px 20px;
    border-radius: 10px;
    transition: 0.3s;
            ...
            <div class="col-md-6">
                <div class="card mt-5">
                    ...
                    <div class="card-footer text-center">
                        <a href="register.php" class="text-decoration-none" style="color:rgb(243, 243, 243); font-weight: bold;">
